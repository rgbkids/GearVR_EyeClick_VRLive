...
namespace VRStandardAssets.Utils
{
    ...
    public class VREyeRaycaster : MonoBehaviour
    {
        ...
        private void EyeRaycast()
        {
			...
			//Ray ray = new Ray(new Vector3(2.0f, 2.0f, 3.0f), m_Camera.forward);
			...
			{
//				Ray ray2 = new Ray(OVRInput.GetLocalControllerPosition, m_Camera.forward);
				//Ray ray2 = new Ray(OVRInput.GetLocalControllerPosition, OVRInput.GetLocalControllerRotation);
				ray = new Ray(OVRInput.GetLocalControllerPosition(controller), m_Camera.forward);

				Debug.Log (OVRInput.GetLocalControllerPosition (controller));
			} 
			*/
